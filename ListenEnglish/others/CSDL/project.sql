...
INSERT INTO `track` VALUES (1,11937,'tracks/1.mp3','In the early days of human history, people survived by hunting wild animals, or gathering wild grains and plants for food.',1,' 7,6,8.'),(2,11153,'tracks/2.mp3','Then, some people learned to grow crops and raise animals for food. They were the first farmers.',1,' 1,11.5.'),(3,14262,'tracks/3.mp3','Since the sixteenth century, the word farm has meant agricultural land. But a much older meaning of the word farm is linked to economics.',1,' 4,7.13.'),(4,9272,'tracks/4.mp3','The word farm comes from the Latin word, firma, which means an unchanging payment.',2,' 6[Latin]1,1,5.'),(5,11676,'tracks/5.mp3','Experts say the earliest meaning of the English word farm was a yearly payment made as a tax or rent.',3,' 7[English]12.'),(6,11232,'tracks/6.mp3','Farmers in early England did not own their land. They paid every year to use agricultural lands.',4,' 3[England]5.8.'),(7,12590,'tracks/7.mp3','In England, farmers used hawthorn trees along the edges of property. They called this row of hawthorns a hedge.',5,' 1[Endland],9.8.'),(8,19147,'tracks/8.mp3','Hedging fields was how careful farmers marked and protected them. Soon, people began to use the word hedging to describe steps that could be taken to protect against financial loss.',6,' 10.1,19.'),(9,23170,'tracks/9.mp3','Hedging is common among gamblers who make large bets. A gambler bets a lot of money on one team. But, to be on the safe side, he also places a smaller bet on the other team, to reduce a possible loss.',6,' 9.10.1,6,10,5.');
...
-- Dump completed on 2012-11-12 21:37:00
